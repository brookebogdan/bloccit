...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe 'POST #create' do
    it 'increases the number of Advertisement by 1' do
      expect {
        post :create, advertisement: {title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: RandomData.random_integer}}.to change(Advertisement, :count).by (1)
    end
